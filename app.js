...
const REASON_GROUPS = {
  ...
  not_attractive: {
    label: "觉得女生不够好看",
    keywords: ["觉得女生不够好看", "不够好看", "没那么好看", "长相一般", "颜值不够"],
    plan: "如果我开始用外貌挑剔拖延，那么先确认自己是否真的有兴趣；没有兴趣就不行动，有兴趣就不让挑剔替我决定。"
  },
  older_age: {
    label: "女生年纪30多了",
    keywords: ["女生年纪30多了", "30多", "三十多", "年纪大", "年龄大"],
    plan: "如果我被年龄猜测阻止，那么不把猜测当成事实；只要自己确实有兴趣、场景也合适，就按边界检查做决定。"
  },
  hesitation: {
    label: "犹豫后错过",
